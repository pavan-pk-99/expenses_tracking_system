...
export default function DashBoard(props) {
  ...
  <Link to="/dashboard">
    <li
      ...
      className={
        active === "1"
          ? "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-jp-black hover:rounded-md bg-jp-black rounded-md text-[#cddafd]"
          : "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-jp-black hover:rounded-md transition delay-100 text-[#cddafd]"
      }
    >
      <span className="mr-3">
        <svg
