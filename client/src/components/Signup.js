...
export default function Signup(props) {
  ...
  const handleSignup = async (e) => {
    ...
    const res = await fetch("https://expenses-tracking-system.onrender.com/user/signup", {
      method: "POST",
      headers: {
      ...
      <div className="p-6 bg-rp-black text-white rounded-xl font-lexend">
        ...
        <div className="grid grid-cols-12">
          ...
          <input
            ...
            className="p-2 m-2 inline-block outline-none bg-jp-black col-span-8 rounded-sm placeholder-rp-white"
          />
        ...
        <p className="">
          ...
          <a className="text-rp-white">terms and conditions</a>
        </p>
        <div className="mt-4">
          {isLoading ? (
            <ReactLoading
            ...
            <button
              ...
              className="font-bold p-3 rounded-xl border-2 border-rp-white text-rp-white hover:border-rp-black hover:text-rp-black hover:bg-rp-yellow hover:scale-110 transition delay-150 duration-200"
            >
              Sign Up
            </button>
          )}
        ...
        <span className="flex justify-center py-2">
          ...
          <span
            className="text-rp-white cursor-pointer"
            onClick={() => {
              props.closeModalSignup();
